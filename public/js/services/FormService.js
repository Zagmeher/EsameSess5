...
export class ApiService {
     ...
     */
    constructor() {
        this.apiUrl = '/api/register'; // Endpoint Laravel per registrazione
     ...
     */
    setupRealtimeValidation(inputElement, validationFn) {
        fromEvent(inputElement, 'input') // Ascolta eventi input
            .pipe(map((event) => event.target.value), // Estrai valore
        ...
        distinctUntilChanged() // Emetti solo se valore cambia
            ...
            const feedbackElement = inputElement.nextElementSibling; // Elemento per messaggio
